...
const HRProfile = () => {
  ...
  const [profileData, setProfileData] = useState({
    fullName: 'HR Manager',
    email: 'hr.manager@aselea.com',
    phone: '+1 (555) 234-5678',
    address: '456 Business Ave, Suite 200, City, State 54321',
    ...
    bio: 'Experienced HR professional with over 10 years in talent management, employee relations, and organizational development.',
  });
